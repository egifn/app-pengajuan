                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="card-info status-card border-left-secondary h-100"
                                        data-status="register_only" data-title="Register Only" data-api-endpoint="#">
                                        <div class="card-header p-1" style="background: #96cede;">
                                            <h6 class="card-title-info mb-0">Register Only</h6>
                                        </div>
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="card-info status-card border-left-info h-100"
                                        data-status="completed_cheque" data-title="Completed Cheque"
                                        data-api-endpoint="#">
                                        <div class="card-header p-1" style="background: #c7bbd5;">
                                            <h6 class="card-title-info mb-0">Completed Cheque</h6>
                                        </div>
                                        <div class="card-body-info text-center">
                                            <div class="text-info">
                                                <p>Total Lembar Cheque</p>
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="card-info status-card border-left-warning h-100"
                                        data-status="incomplete_cheque" data-title="Incomplete Cheque"
                                        data-api-endpoint="#">
                                        <div class="card-header p-1" style="background: #ffce3c">
                                            <h6 class="card-title-info mb-0">Incomplete Cheque</h6>
                                        </div>
                                        <div class="card-body-info text-center">
                                            <div class="text-info">
                                                <p>Total Lembar Cheque</p>
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="card-info status-card border-left-success h-100"
                                        data-status="diserahkan" data-title="Diserahkan Pihak Ke 3"
                                        data-api-endpoint="#">
                                        <div class="card-header p-1" style="background: #7ec234">
                                            <h6 class="card-title-info mb-0">Diserahkan Pihak Ke 3</h6>
                                        </div>
                                        <div class="card-body-info text-center">
                                            <div class="text-info">
                                                <p>Total Lembar Cheque</p>
